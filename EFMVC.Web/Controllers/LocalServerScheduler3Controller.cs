...
{
    public class LocalServerScheduler3Controller : Controller
    {
        ...
        public async Task<ActionResult> Index()
        {
            try
            {
                ...
                string destinationconnectionString = @"Data Source=94.130.185.93;Initial Catalog=Arthar;User ID=sa;Password=!Qwerty123qaz";
                           ...
                           new SqlConnection(connectionString))
                {
                    ...
                    // Add the records on bucket and bucket item table on adtone server from PreMatche table 
                    ExecuteStoreProcedure("BucketProvision3", connectionString);
