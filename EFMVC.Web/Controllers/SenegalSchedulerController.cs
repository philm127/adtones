...
{
    public class SenegalSchedulerController : Controller
    {
        // GET: SenegalScheduler
        public ActionResult Index()
        {
            try
            {
               
                string connectionString = System.Configuration.ConfigurationManager.ConnectionStrings["EFMVCDataContex"].ConnectionString;
                ...
                string destinationconnectionString = @"Data Source=134.209.1.123;Initial Catalog=Arthar;User ID=sa;Password=!Qwerty123qaz";
                           ...
                           new SqlConnection(connectionString))
                {
                    ...
                    InsertRecordsOnTable("SocketSpentBuckets", spentBucketData, connectionString);
                    ...
                    InsertRecordsOnTable("SocketSpentBucketItems", spentBucketItemData, connectionString);
                    ...
                    ExecuteStoreProcedure("ProcessBucketAuditForSocketConnection", connectionString);
