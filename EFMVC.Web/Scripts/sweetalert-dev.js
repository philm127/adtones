        ...
        1: [function (require, module, exports) {
            ...
            exports['default'] = sweetAlert = swal = function () {
                ...
                switch (typeof customizations) {
                    ...
                    case 'object':
                        ...
                        params.buttons = customizations.buttons;
                        break;
            ...
            var handleButton = function handleButton(event, params, modal) {
                ...
                function shouldSetConfirmButtonColor(color) {
                    if (targetedConfirm && params.confirmButtonColor && target) {
            ...
            var setParameters = function setParameters(params) {
                ...
                var $buttonsContainer = modal.querySelector('.sa-button-container');
                ...
                * Buttons
                */
                var $buttonsListContainer = modal.querySelector('.sa-buttons-container');
                if (params.buttons) {
                    //$buttonsContainer.innerHTML = '';
                    document.querySelector('.sa-confirm-button-container').style.display = 'none';
                    if (!$buttonsListContainer) {
                        $buttonsListContainer = document.createElement('div');
                        $buttonsListContainer.className = 'sa-buttons-container';


                        params.buttons.forEach(function ($btn) {
                            var $button = document.createElement('span');
                            $button.textContent = $btn.text;
                            $button.className = 'button ' + $btn.className;
                        ...
                        $buttonsContainer.appendChild($buttonsListContainer);
                    }
                }
                else {
                    document.querySelector('.sa-confirm-button-container').style.display = 'block';
                    if ($buttonsListContainer) {
                        $buttonsListContainer.parentNode.removeChild($buttonsListContainer);
                    }
                }
