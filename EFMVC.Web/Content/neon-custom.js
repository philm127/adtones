...
;(function($, window, undefined){
	...
	$(document).ready(function()
	{
		...
		replaceCheckboxes();
		//Add Pagination class For Responsive Design 
...
function responsivePaginationDesign() {
    $("table").next("div").addClass("custompagination");
    $(".custompagination > div").removeClass("col-xs-6").addClass("col-xs-12 col-sm-6");
}
