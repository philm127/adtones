...
namespace EFMVC.Web.Areas.UsersAdmin.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController(ICommandBus commandBus, IContactsRepository contactsRepository, ICompanyDetailsRepository companydetailsRepository, IUserRepository userRepository, ICountryRepository countryRepository, IRewardRepository rewardRepository)
        {
        ...
        //        _profileinfo.LastName = userinfo.LastName;
        //        _profileinfo.Organisation = userinfo.Organisation;
        //        _profileinfo.RewardId = userinfo.RewardId;
        //    }
        //    ContactsFormModel contactmodel = new ContactsFormModel();
        //    CompanyDetailsFormModel companymodel = new CompanyDetailsFormModel();
        //    var _contactinfo = _contactsRepository.GetMany(top => top.UserId == efmvcUser.UserId).FirstOrDefault();
        ...
        private void FillRewardList()
        {
            ...
            var reward = (from action in _rewardRepository.GetAll()
                          select new SelectListItem
                          {
