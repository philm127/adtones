...
namespace EFMVC.Web.Areas.Admin.Controllers
{
    ...
    public class AdminUserProfileController : Controller
    {
        ...
        public AdminUserProfileController(ICommandBus commandBus, IContactsRepository contactsRepository, ICompanyDetailsRepository companydetailsRepository, IUserRepository userRepository, ICountryRepository countryRepository)
        {
