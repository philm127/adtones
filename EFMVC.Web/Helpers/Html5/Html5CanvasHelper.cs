...
namespace System.Web.Mvc.Html
{
    ...
    public class Html5CanvasHelper : IHtml5CanvasHelper
    {
        ...
        #region IHtml5CanvasHelper Members
        ...
        {
            var tagBuilder = new TagBuilder("canvas");
        ...
        public MvcHtmlString Rectangle(string name, string notSupportedMessage, int x, int y, int width, int height,
                                       int thickness, string lineColor, object htmlAttributes)
        {
            return CreateCanvasRect(name, notSupportedMessage, x, y, width, height, thickness, lineColor, htmlAttributes,
                                    DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledRectangle(string name, string notSupportedMessage, int x, int y, int width,
                                             int height, string fillColor, object htmlAttributes)
        {
            return CreateCanvasRect(name, notSupportedMessage, x, y, width, height, 0, fillColor, htmlAttributes,
                                    DrawMode.Fill);
        }
        ...
        public MvcHtmlString Ellipse(string name, string notSupportedMessage, int cx, int cy, int width, int height,
                                     int thickness, string lineColor, object htmlAttributes)
        {
            if (width == height)
                return CreateCanvasCircle(name, notSupportedMessage, cx, cy, width/2, thickness, lineColor,
                                          htmlAttributes, DrawMode.Stroke);
            return CreateCanvasEllipse(name, notSupportedMessage, cx, cy, width, height, thickness, lineColor,
                                       htmlAttributes, DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledEllipse(string name, string notSupportedMessage, int cx, int cy, int width,
                                           int height, string fillColor, object htmlAttributes)
        {
            if (width == height)
                return CreateCanvasCircle(name, notSupportedMessage, cx, cy, width/2, 0, fillColor, htmlAttributes,
                                          DrawMode.Fill);
            return CreateCanvasEllipse(name, notSupportedMessage, cx, cy, width, height, 0, fillColor, htmlAttributes,
                                       DrawMode.Fill);
        }
        ...
        public MvcHtmlString Circle(string name, string notSupportedMessage, int x, int y, float radius, int thickness,
                                    string lineColor, object htmlAttributes)
        {
            return CreateCanvasCircle(name, notSupportedMessage, x, y, radius, thickness, lineColor, htmlAttributes,
                                      DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledCircle(string name, string notSupportedMessage, int x, int y, float radius,
                                          string fillColor, object htmlAttributes)
        {
            return CreateCanvasCircle(name, notSupportedMessage, x, y, radius, 0, fillColor, htmlAttributes,
                                      DrawMode.Fill);
        }
        ...
        public MvcHtmlString Arc(string name, string notSupportedMessage, int x, int y, float radius, int thickness,
                                 float startAngle, float endAngle, string lineColor, object htmlAttributes)
        {
            return CreateCanvasArc(name, notSupportedMessage, x, y, radius, thickness, startAngle, endAngle, lineColor,
                                   htmlAttributes, DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledArc(string name, string notSupportedMessage, int x, int y, float radius,
                                       float startAngle, float endAngle, string fillColor, object htmlAttributes)
        {
            return CreateCanvasArc(name, notSupportedMessage, x, y, radius, 0, startAngle, endAngle, fillColor,
                                   htmlAttributes, DrawMode.Fill);
        }
        ...
        public MvcHtmlString BeizerCurve(string name, string notSupportedMessage, int x1, int y1, int x2, int y2,
                                         float radius, int thickness, string lineColor, object htmlAttributes)
        {
            return CreateCanvasBeizerCurve(name, notSupportedMessage, x1, y1, x2, y2, radius, thickness, lineColor,
                                           htmlAttributes, DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledBeizerCurve(string name, string notSupportedMessage, int x1, int y1, int x2, int y2,
                                               float radius, string fillColor, object htmlAttributes)
        {
            return CreateCanvasBeizerCurve(name, notSupportedMessage, x1, y1, x2, y2, radius, 0, fillColor,
                                           htmlAttributes, DrawMode.Fill);
        }
        ...
        public MvcHtmlString QuadraticCurve(string name, string notSupportedMessage, int x1, int y1, int x2, int y2,
                                            int thickness, string lineColor, object htmlAttributes)
        {
            return CreateCanvasQuadraticCurve(name, notSupportedMessage, x1, y1, x2, y2, thickness, lineColor,
                                              htmlAttributes, DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledQuadraticCurve(string name, string notSupportedMessage, int x1, int y1, int x2,
                                                  int y2, string fillColor, object htmlAttributes)
        {
            return CreateCanvasQuadraticCurve(name, notSupportedMessage, x1, y1, x2, y2, 0, fillColor, htmlAttributes,
                                              DrawMode.Fill);
        }
        ...
        public MvcHtmlString Polygon(string name, string notSupportedMessage, Point[] points, int thickness,
                                     string lineColor, object htmlAttributes)
        {
            return CreateCanvasPolygon(name, notSupportedMessage, points, thickness, lineColor, htmlAttributes,
                                       DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledPolygon(string name, string notSupportedMessage, Point[] points, string fillColor,
        ...
        public MvcHtmlString Text(string name, string notSupportedMessage, int x, int y, string text, string fontFamily,
                                  int fontSize, string fontStyle, int thickness, string lineColor, object htmlAttributes)
        {
            return CreateCanvasText(name, notSupportedMessage, x, y, text, fontFamily, fontSize, fontStyle, thickness,
                                    lineColor, htmlAttributes, DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledText(string name, string notSupportedMessage, int x, int y, string text,
                                        string fontFamily, int fontSize, string fontStyle, string fillColor,
                                        object htmlAttributes)
        {
            return CreateCanvasText(name, notSupportedMessage, x, y, text, fontFamily, fontSize, fontStyle, 0, fillColor,
                                    htmlAttributes, DrawMode.Fill);
        }
        ...
        public MvcHtmlString Line(string name, string notSupportedMessage, int x1, int y1, int x2, int y2, int thickness,
                                  string lineColor, object htmlAttributes)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
        ...
        public MvcHtmlString Image(string name, string notSupportedMessage, int x, int y, int width, int height,
                                   string imageUrl, object htmlAttributes)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
            {
        ...
        /// </summary>
        private MvcHtmlString CreateCanvasRect(string name, string notSupportedMessage, int xPosition, int yPosition,
                                               int rectWidth, int rectHeight, int thickness, string color,
                                               object htmlAttributes, DrawMode drawMode)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
            {
            ...
            scriptStringBuilder.AppendLine();
            if (drawMode == DrawMode.Fill)
                scriptStringBuilder.AppendFormat("context.fillRect({0},{1},{2},{3});", xPosition, yPosition, rectWidth,
                                                 rectHeight);
            else
                scriptStringBuilder.AppendFormat("context.strokeRect({0},{1},{2},{3});", xPosition, yPosition, rectWidth,
                                                 rectHeight);
            scriptStringBuilder.AppendLine();
            scriptTagBuilder.InnerHtml = scriptStringBuilder.ToString();
            string scriptTag = scriptTagBuilder.ToString(TagRenderMode.Normal);
        ...
        /// </summary>
        private MvcHtmlString CreateCanvasEllipse(string name, string notSupportedMessage, int centerX, int centerY,
                                                  int width, int height, int thickness, string color,
                                                  object htmlAttributes, DrawMode drawMode)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
            ...
            scriptStringBuilder.AppendFormat(
                "context.bezierCurveTo({0} + {1} / 2, {2} - {3} / 2, {0} + {1} / 2, {2} + {3} / 2, {0}, {2} + {3} / 2);",
        ...
        /// </summary>
        private MvcHtmlString CreateCanvasCircle(string name, string notSupportedMessage, int centerX, int centerY,
                                                 float radius, int thickness, string color, object htmlAttributes,
                                                 DrawMode drawMode)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
            ...
            if (drawMode == DrawMode.Stroke)
                scriptStringBuilder.AppendFormat("context.lineWidth = {0};", thickness);
            scriptStringBuilder.AppendLine();
            scriptStringBuilder.AppendFormat("context.arc({0}, {1}, {2}, 0, Math.PI * 2, true);", centerX, centerY,
                                             radius);
            scriptStringBuilder.AppendLine();
            if (drawMode == DrawMode.Fill)
                scriptStringBuilder.AppendLine("context.fill();");
        ...
        /// </summary>
        private MvcHtmlString CreateCanvasArc(string name, string notSupportedMessage, int centerX, int centerY,
                                              float radius, int thickness, float startAngle, float endAngle,
                                              string color, object htmlAttributes, DrawMode drawMode)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
            {
            ...
            scriptStringBuilder.AppendLine();
            scriptStringBuilder.AppendFormat(
                "context.arc({0}, {1}, {2}, {3} * Math.PI/180, {4} * Math.PI/180, false);", centerX, centerY, radius,
                startAngle, endAngle);
            scriptStringBuilder.AppendLine();
            if (drawMode == DrawMode.Fill)
                scriptStringBuilder.AppendLine("context.fill();");
        ...
        /// </summary>
        private MvcHtmlString CreateCanvasBeizerCurve(string name, string notSupportedMessage, int startX, int startY,
                                                      int endX, int endY, float radius, int thickness, string color,
                                                      object htmlAttributes, DrawMode drawMode)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
            ...
            scriptStringBuilder.AppendLine();
            scriptStringBuilder.AppendFormat(
                "context.bezierCurveTo({0}, {1}, {2}, {3} , {4}* Math.PI/180, {5} * Math.PI/180);", startX, startY, endX,
                endY, radius, 200);
            scriptStringBuilder.AppendLine();
            if (drawMode == DrawMode.Fill)
                scriptStringBuilder.AppendLine("context.fill();");
        ...
        /// </summary>
        private MvcHtmlString CreateCanvasQuadraticCurve(string name, string notSupportedMessage, int startX, int startY,
                                                         int endX, int endY, int thickness, string color,
                                                         object htmlAttributes, DrawMode drawMode)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
        ...
        /// </summary>
        private MvcHtmlString CreateCanvasPolygon(string name, string notSupportedMessage, Point[] points, int thickness,
                                                  string color, object htmlAttributes, DrawMode drawMode)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
            ...
            scriptStringBuilder.AppendLine(
                "for( item=2 ; item < points.length-1 ; item+=2 ){ context.lineTo( points[item] , points[item+1] ) }");
            scriptStringBuilder.AppendLine("context.closePath();");
            if (drawMode == DrawMode.Fill)
                scriptStringBuilder.AppendLine("context.fill();");
            else
        ...
        /// </summary>
        private MvcHtmlString CreateCanvasText(string name, string notSupportedMessage, int xPosition, int yPosition,
                                               string text, string fontFamily, int fontSize, string fontStyle,
                                               int thickness, string color, object htmlAttributes, DrawMode drawMode)
        {
            var tagBuilder = new TagBuilder("canvas");
            if (htmlAttributes != null)
            {
