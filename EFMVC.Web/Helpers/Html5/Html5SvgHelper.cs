...
namespace System.Web.Mvc.Html
{
    ...
    public class Html5SvgHelper : IHtml5SvgHelper
    {
        ...
        #region IHtml5SvgHelper Members
        ...
        {
            return CreateSvgRect(name, notSupportedMessage, x, y, width, height, thickness, lineColor, htmlAttributes,
                                 DrawMode.Stroke);
        }
        ...
        {
            if (width == height)
                return CreateSvgCircle(name, notSupportedMessage, cx, cy, width/2, thickness, lineColor, htmlAttributes,
                                       DrawMode.Stroke);
            return CreateSvgEllipse(name, notSupportedMessage, cx, cy, width, height, thickness, lineColor,
        ...
        public MvcHtmlString Circle(string name, string notSupportedMessage, int cx, int cy, float radius, int thickness,
                                    string lineColor, object htmlAttributes)
        {
            return CreateSvgCircle(name, notSupportedMessage, cx, cy, radius, thickness, lineColor, htmlAttributes,
                                   DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledCircle(string name, string notSupportedMessage, int cx, int cy, float radius,
                                          string fillColor, object htmlAttributes)
        {
            return CreateSvgCircle(name, notSupportedMessage, cx, cy, radius, 0, fillColor, htmlAttributes,
                                   DrawMode.Fill);
        }
        ...
        public MvcHtmlString Polygon(string name, string notSupportedMessage, Point[] points, int thickness,
                                     string lineColor, object htmlAttributes)
        {
            return CreateSvgPolygon(name, notSupportedMessage, points, thickness, lineColor, htmlAttributes,
                                    DrawMode.Stroke);
        }
        ...
        public MvcHtmlString Text(string name, string notSupportedMessage, int x, int y, string text, string fontFamily,
                                  int fontSize, string fontWeight, string fontStyle, string textDecoration,
                                  int thickness, string lineColor, object htmlAttributes)
        {
            return CreateSvgText(name, notSupportedMessage, x, y, text, fontFamily, fontSize, fontWeight, fontStyle,
                                 textDecoration, thickness, lineColor, htmlAttributes, DrawMode.Stroke);
        }
        ...
        public MvcHtmlString FilledText(string name, string notSupportedMessage, int x, int y, string text,
                                        string fontFamily, int fontSize, string fontWeight, string fontStyle,
                                        string textDecoration, string fillColor, object htmlAttributes)
        {
            return CreateSvgText(name, notSupportedMessage, x, y, text, fontFamily, fontSize, fontWeight, fontStyle,
                                 textDecoration, 0, fillColor, htmlAttributes, DrawMode.Fill);
        }
        ...
        {
            TagBuilder tagBuilder = CreateSvgTag(name, notSupportedMessage, htmlAttributes);
            var lineTagBuilder = new TagBuilder("line");
        ...
        public MvcHtmlString PolyLine(string name, string notSupportedMessage, Point[] points, int thickness,
                                      string lineColor, object htmlAttributes)
        {
            TagBuilder tagBuilder = CreateSvgTag(name, notSupportedMessage, htmlAttributes);
            var polylineTagBuilder = new TagBuilder("polyline");
        ...
        {
            TagBuilder tagBuilder = CreateSvgTag(name, notSupportedMessage, htmlAttributes);
            var imgTagBuilder = new TagBuilder("image");
        ...
        /// </summary>
        private MvcHtmlString CreateSvgRect(string name, string notSupportedMessage, int xPosition, int yPosition,
                                            int rectWidth, int rectHeight, int thickness, string color,
                                            object htmlAttributes, DrawMode drawMode)
        {
            TagBuilder tagBuilder = CreateSvgTag(name, notSupportedMessage, htmlAttributes);
            var rectTagBuilder = new TagBuilder("rect");
        ...
        /// </summary>
        private MvcHtmlString CreateSvgEllipse(string name, string notSupportedMessage, int centerX, int centerY,
                                               int width, int height, int thickness, string color, object htmlAttributes,
                                               DrawMode drawMode)
        {
            TagBuilder tagBuilder = CreateSvgTag(name, notSupportedMessage, htmlAttributes);
            var ellipseTagBuilder = new TagBuilder("ellipse");
        ...
        /// </summary>
        private MvcHtmlString CreateSvgCircle(string name, string notSupportedMessage, int centerX, int centerY,
                                              float radius, int thickness, string color, object htmlAttributes,
                                              DrawMode drawMode)
        {
            TagBuilder tagBuilder = CreateSvgTag(name, notSupportedMessage, htmlAttributes);
            var circleTagBuilder = new TagBuilder("circle");
        ...
        /// </summary>
        private MvcHtmlString CreateSvgPolygon(string name, string notSupportedMessage, Point[] points, int thickness,
                                               string color, object htmlAttributes, DrawMode drawMode)
        {
            TagBuilder tagBuilder = CreateSvgTag(name, notSupportedMessage, htmlAttributes);
            var polygonTagBuilder = new TagBuilder("polygon");
        ...
        /// </summary>
        private MvcHtmlString CreateSvgText(string name, string notSupportedMessage, int xPosition, int yPosition,
                                            string text, string fontFamily, int fontSize, string fontWeight,
                                            string fontStyle, string textDecoration, int thickness, string color,
                                            object htmlAttributes, DrawMode drawMode)
        {
            TagBuilder tagBuilder = CreateSvgTag(name, notSupportedMessage, htmlAttributes);
            var textTagBuilder = new TagBuilder("text");
