...
namespace System.Web.Mvc.Html
{
    ...
    public class Html5MediaHelper : IHtml5MediaHelper
    {
        ...
        #region IHtml5MediaHelper Members
        ...
        /// <returns>A audio element.</returns>
        public MvcHtmlString Audio(string name, string source, string notSupportedMessage, bool showControls,
                                   bool autoPlay, bool playInLoop)
        {
        ...
        /// <returns>A audio element.</returns>
        public MvcHtmlString Audio(string name, string source, string notSupportedMessage, bool showControls,
                                   bool autoPlay, bool playInLoop, object htmlAttributes)
        {
        ...
        /// <returns>A audio element.</returns>
        public MvcHtmlString Audio(string name, IEnumerable<SourceListItem> sourceList, string notSupportedMessage,
                                   bool showControls, bool autoPlay, bool playInLoop)
        {
        ...
        /// <returns>A audio element.</returns>
        public MvcHtmlString Audio(string name, IEnumerable<SourceListItem> sourceList, string notSupportedMessage,
                                   bool showControls, bool autoPlay, bool playInLoop, object htmlAttributes)
        {
            var tagBuilder = new TagBuilder("audio");
            if (htmlAttributes != null)
            {
            ...
            if (playInLoop)
                tagBuilder.MergeAttribute("loop", "loop");
            tagBuilder.MergeAttribute("id", name);
            var sourceItemBuilder = new StringBuilder();
            sourceItemBuilder.AppendLine();
            foreach (SourceListItem sourceItem in sourceList)
            {
        ...
        /// <returns>A video element.</returns>
        public MvcHtmlString Video(string name, string source, string notSupportedMessage, bool showControls,
                                   bool autoPlay, bool playInLoop)
        {
        ...
        public MvcHtmlString Video(string name, IEnumerable<SourceListItem> sourceList, ObjectType objectType,
                                   string objectSource)
        {
        ...
        /// <returns>A video element containing a inner object element.</returns>
        public MvcHtmlString Video(string name, IEnumerable<SourceListItem> sourceList, ObjectType objectType,
                                   string objectSource, object htmlAttributes)
        {
            var tagBuilder = new TagBuilder("video");
            if (htmlAttributes != null)
            {
        ...
        private string CreateFlashObject(string flashSource, object htmlAttributes)
        {
            ...
            var objectItemBuilder = new StringBuilder();
        ...
        /// </summary>
        private string CreateSilverlightObject(IEnumerable<SourceListItem> sourceList, string xapSource,
                                               object htmlAttributes)
        {
            var objectBuilder = new TagBuilder("object");
            if (htmlAttributes != null)
            ...
            var paramBuilder1 = new TagBuilder("param");
            ...
            var paramBuilder2 = new TagBuilder("param");
            ...
            string initParamsString = "deferredLoad=true, duration=0, m=" + sourceUrl +
            ...
            var paramBuilder3 = new TagBuilder("param");
        ...
        {
            var builder = new TagBuilder("source");
            builder.MergeAttribute("type", sourceItem.SourceType);
            builder.MergeAttribute("src",
                                   UrlHelper.GenerateContentUrl(sourceItem.Source, htmlHelper.ViewContext.HttpContext));
