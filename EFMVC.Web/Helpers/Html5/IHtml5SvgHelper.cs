...
namespace System.Web.Mvc.Html
{
    ...
    public interface IHtml5SvgHelper
    {
        ...
        MvcHtmlString Circle(string name, string notSupportedMessage, int cx, int cy, float radius, int thickness,
        ...
        MvcHtmlString FilledCircle(string name, string notSupportedMessage, int cx, int cy, float radius,
                                   string fillColor, object htmlAttributes);
        ...
        MvcHtmlString Text(string name, string notSupportedMessage, int x, int y, string text, string fontFamily,
                           int fontSize, string fontWeight, string fontStyle, string textDecoration, int thickness,
                           string lineColor, object htmlAttributes);
        ...
        MvcHtmlString PolyLine(string name, string notSupportedMessage, Point[] points, int thickness, string lineColor,
                               object htmlAttributes);
