...
namespace System.Web.Mvc.Html
{
    ...
    public interface IHtml5MediaHelper
    {
        ...
        /// <returns>A audio element.</returns>
        MvcHtmlString Audio(string name, string source, string notSupportedMessage, bool showControls, bool autoPlay,
                            bool playInLoop);
        ...
        /// <returns>A audio element.</returns>
        MvcHtmlString Audio(string name, string source, string notSupportedMessage, bool showControls, bool autoPlay,
                            bool playInLoop, object htmlAttributes);
        ...
        /// <returns>A video element.</returns>
        MvcHtmlString Video(string name, string source, string notSupportedMessage, bool showControls, bool autoPlay,
                            bool playInLoop);
        ...
        MvcHtmlString Video(string name, IEnumerable<SourceListItem> sourceList, ObjectType objectType,
                            string objectSource);
