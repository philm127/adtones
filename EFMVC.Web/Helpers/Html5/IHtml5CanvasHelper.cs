...
namespace System.Web.Mvc.Html
{
    ...
    public interface IHtml5CanvasHelper
    {
        ...
        MvcHtmlString Rectangle(string name, string notSupportedMessage, int x, int y, int width, int height,
        ...
        MvcHtmlString FilledRectangle(string name, string notSupportedMessage, int x, int y, int width, int height,
        ...
        MvcHtmlString Ellipse(string name, string notSupportedMessage, int cx, int cy, int width, int height,
                              int thickness, string lineColor, object htmlAttributes);
        ...
        MvcHtmlString FilledEllipse(string name, string notSupportedMessage, int cx, int cy, int width, int height,
                                    string fillColor, object htmlAttributes);
        ...
        MvcHtmlString Circle(string name, string notSupportedMessage, int x, int y, float radius, int thickness,
        ...
        MvcHtmlString FilledCircle(string name, string notSupportedMessage, int x, int y, float radius, string fillColor,
        ...
        MvcHtmlString Arc(string name, string notSupportedMessage, int x, int y, float radius, int thickness,
        ...
        MvcHtmlString FilledArc(string name, string notSupportedMessage, int x, int y, float radius, float startAngle,
                                float endAngle, string fillColor, object htmlAttributes);
        ...
        MvcHtmlString BeizerCurve(string name, string notSupportedMessage, int x1, int y1, int x2, int y2, float radius,
                                  int thickness, string lineColor, object htmlAttributes);
        ...
        MvcHtmlString FilledBeizerCurve(string name, string notSupportedMessage, int x1, int y1, int x2, int y2,
        ...
        MvcHtmlString QuadraticCurve(string name, string notSupportedMessage, int x1, int y1, int x2, int y2,
                                     int thickness, string lineColor, object htmlAttributes);
        ...
        MvcHtmlString FilledQuadraticCurve(string name, string notSupportedMessage, int x1, int y1, int x2, int y2,
                                           string fillColor, object htmlAttributes);
        ...
        MvcHtmlString Polygon(string name, string notSupportedMessage, Point[] points, int thickness, string lineColor,
                              object htmlAttributes);
        ...
        MvcHtmlString FilledPolygon(string name, string notSupportedMessage, Point[] points, string fillColor,
                                    object htmlAttributes);
        ...
        MvcHtmlString Text(string name, string notSupportedMessage, int x, int y, string text, string fontFamily,
        ...
        MvcHtmlString FilledText(string name, string notSupportedMessage, int x, int y, string text, string fontFamily,
                                 int fontSize, string fontStyle, string fillColor, object htmlAttributes);
        ...
        MvcHtmlString Line(string name, string notSupportedMessage, int x1, int y1, int x2, int y2, int thickness,
                           string lineColor, object htmlAttributes);
        ...
        MvcHtmlString Image(string name, string notSupportedMessage, int x, int y, int width, int height,
