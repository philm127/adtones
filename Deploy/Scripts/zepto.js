...
(function(undefined) {
    if (String.prototype.trim === undefined) // fix for iOS 3.2
        String.prototype.trim = function() { return this.replace(/^\s+|\s+$/g, ''); }; // For iOS 3.x
...
var Zepto = (function() {
    ...
    zepto.init = function(selector, context) {
        ...
        if (!selector) return zepto.Z();
            ...
            var dom; // normalize array if an array of nodes is given
    ...
    $.camelCase = camelize;
    $.trim = function(str) { return str.trim(); }; // plugin compatibility
    $.uuid = 0;
    $.support = { };
    $.expr = { };
...
(function($) {
    ...
    function detect(ua) {
        var os = this.os = { }, browser = this.browser = { },
            ...
            firefox = ua.match(/Firefox\/([\d.]+)/); // Todo: clean this up with a better OS/browser seperation:
...
(function($) {
    var data = { }, dataAttr = $.fn.data, camelize = $.camelCase,
        exp = $.expando = 'Zepto' + (+new Date()); // Get value from node:
