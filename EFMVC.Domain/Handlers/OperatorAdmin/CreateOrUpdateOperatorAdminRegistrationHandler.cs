...
namespace EFMVC.Domain.Handlers.OperatorAdmin
{
    public class CreateOrUpdateOperatorAdminRegistrationHandler : ICommandHandler<CreateOrUpdateOperatorAdminRegistrationCommand>
    {
        /// <summary>
        ...
        public CreateOrUpdateOperatorAdminRegistrationHandler(IUserRepository userRepository, IUnitOfWork unitOfWork)
        {
            _userRepository = userRepository;
            _unitOfWork = unitOfWork;
        }

        #region ICommandHandler<CreateOrUpdateOperatorAdminRegistrationCommand> Members
        ...
        ///
        public ICommandResult Execute(CreateOrUpdateOperatorAdminRegistrationCommand command)
        {
            User user = null;
            if (command.UserId != 0)
            {
                ...
                if (user != null)
                {
                    ...
                    user.LastPasswordChangedDate = command.LastPasswordChangedDate;
                }
            }
            else
            {
                    ...
                    foreach (var item in ConnString)
                    {
                        ...
                        if (user3 != null)
                        {
                            ...
                            if (externalServerCountryId != 0 && externalOperatorId != 0)
                            {
                                ...
                                user3.LastPasswordChangedDate = command.LastPasswordChangedDate;
                                db.SaveChanges();
                            }
