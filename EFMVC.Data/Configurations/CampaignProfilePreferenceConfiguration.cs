...
{
   public class CampaignProfilePreferenceConfiguration : EntityTypeConfiguration<CampaignProfilePreference>
    {
        public CampaignProfilePreferenceConfiguration()
        {
            ToTable("CampaignProfilePreference");
            Property(u => u.CampaignProfileId).IsRequired();
            Property(u => u.DOBStart_Demographics);
            Property(u => u.DOBEnd_Demographics);
