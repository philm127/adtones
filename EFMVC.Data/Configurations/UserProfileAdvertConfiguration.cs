...
// ***********************************************************************
// <copyright file="UserProfileAdvertConfiguration.cs" company="Noat">
...
{
    /// <summary>
    /// Class UserProfileAdvertConfiguration.
    /// </summary>
    public class UserProfileAdvertConfiguration : EntityTypeConfiguration<UserProfileAdvert>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserProfileAdvertConfiguration"/> class.
        /// </summary>
        public UserProfileAdvertConfiguration()
        {
            ToTable("UserProfileAdvert");
